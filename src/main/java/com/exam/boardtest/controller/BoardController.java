package com.exam.boardtest.controller;

import com.exam.boardtest.dto.BoardDTO;
import com.exam.boardtest.service.BoardService;
...
public class BoardController {
  ...
  @PostMapping("/insert")
  public String insert(@ModelAttribute BoardDTO boardDTO) throws IOException {
  ...
  public String paging(@PageableDefault(page = 1) Pageable pageable, Model model) {
    ...
    int endPage = ((startPage + blockLimit - 1) < boardDTOPage.getTotalPages())
            ? startPage + blockLimit - 1
            : boardDTOPage.getTotalPages();
